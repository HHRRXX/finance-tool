...
st.title("30 Dow Jones Industrial Stocks finance tool")
...
trained_sac_path = "pages/trained_models/trained_sac_30_full/"
...
st.write("Here's our action everyday to 30 dow stocks:")
st.write(df_actions)
st.write("Here's our report to 30 dow stocks:")
st.write(perf_stats_all)
st.write("Here's our daily return to 30 dow stocks:")
